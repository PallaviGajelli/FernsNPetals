...
//Verify the functionality  of recipients name field in delivery details page
public class Fnp_Plants_027 extends TestBase {
	
	@Test
	public void Fnp_Plants_027() throws Exception {
		try {
...
//			Ex:Enter name with the combination of alphanumeric an special characters
//			*Note:Expected step1 has to be verified
			
//			Browser should display the name in the text field 
