...
//Verify the functionality  of recipients  mobile number field in delivery details page
public class Fnp_Plants_030 extends TestBase {
	@Test
	public void Fnp_Plants_030() throws Exception {
		try {
...
//			
//			Browser should display the mobile number in the textbox.
