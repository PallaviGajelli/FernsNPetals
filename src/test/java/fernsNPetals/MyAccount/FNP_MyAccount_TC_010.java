...
//Verify the functionality of the My Orders link in Account page
public class FNP_MyAccount_TC_010 extends TestBase{
	@Test
	public void FNP_MyAccount_TC_010() throws Exception {
		try {
...
//			5.click on continue button
			Accounts.continuebtninAccounts.click();
			Thread.sleep(1000);
//			7.click on the My Orders
			Accounts.MyOrders.click();
			Thread.sleep(1000);
//			Browser should display the following field:My Orders
			Assert.assertEquals((Accounts.ordersinMyOrders.isDisplayed()), true);
			System.out.println("My Orders is displayed");
