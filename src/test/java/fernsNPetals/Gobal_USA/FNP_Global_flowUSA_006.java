...
//Verify user able to Add the Product To Cart in gift booking window
public class FNP_Global_flowUSA_006 extends TestBase{
	@Test
	public void FNP_Global_flowUSA_006() throws Exception {
		try {
...
//			1.Browser should display in header tool bar added product in the cart
