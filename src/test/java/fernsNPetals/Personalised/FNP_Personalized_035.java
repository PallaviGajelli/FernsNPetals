...
//Verify the functionality of the Add To Cart button without entering data
public class FNP_Personalized_035 extends TestBase{
	@Test
	public void FNP_Personalized_035() throws Exception {
		try {
