...
public class FNP_Personalized_034 extends TestBase{
	@Test
	public void FNP_Personalized_034() throws Exception {
		try {
...
//			4.Click on any product 
			...
			Thread.sleep(2000);
			GiftPage.giftwindowVerification("Shining Memory Personalized Lamp");

//			
//			Browser should display the following fields in the gift booking window:
//				a) Home> Shining Memory Personalized Lamp
//				b) Shining Memory Personalized Lamp,Cost,Reviews
//				c) Area/ pin code text box
