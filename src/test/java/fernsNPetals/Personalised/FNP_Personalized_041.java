...
//Verify the functionality of the Buy Now button with Entering data by selecting Add-on
public class FNP_Personalized_041 extends TestBase {
	@Test
	public void FNP_Personalized_041() throws Exception {
		try {
...
//			11.Click on continue with one Add-on
			...
			Thread.sleep(2000);
//			*Note:Expected step1 has to be verified Browser should navigate to Login/Sign up page
