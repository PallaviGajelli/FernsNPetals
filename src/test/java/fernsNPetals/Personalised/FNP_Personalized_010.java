...
//Verify the functionality of the Buy Now button for upload image product without Entering data
public class FNP_Personalized_010 extends TestBase {
	
	@Test
	public void FNP_Personalized_010() throws Exception {
		try {
...
//			Browser should display an error message 'select Delivery Area to continue'
