...
//	public WebElement checklogin;
	...
	public  WebElement FreeDelivery;// under today
	@FindBy(xpath = "//*[@id=\"today\"]/ul/li[1]/div[1]")
	public  WebElement StdDeliveryunderToday;

	@FindBy(xpath = "//*[@id=\"selecte_date-tb\"]/ul/li[2]/div[1]")
	public  WebElement StdDeliveryunderCalender;
	@FindBy(xpath = "//*[@id=\"selecte_date-tb\"]/ul/li[2]/div[2]/ul/li[2]")
	public  WebElement TSlot12to15undercalender;
...
// /html/body/div[1]/div
	...
	public void selectDayAfterTomorrow1(WebDriver driver) {
		Date date = new Date();
		SimpleDateFormat dateF = new SimpleDateFormat("dd/MMMM/yyyy");
		Calendar cal = Calendar.getInstance();
		...
		if (dd.startsWith("0")) {
 		...
 		if (!(after2days.isDisplayed())) {
			int ddnew = Integer.parseInt(dd);
			for (int i = 1; after2days.isEnabled(); i++) {
				ddnew = ddnew + i;
				after2days = driver.findElement(By.xpath("//a[text()='" + ddnew + "']"));
			}
		} 
	after2days.click();
